...
Description: Smart lazy shortcode macros for bob/fob bing/bong wide/hide wow, WoW and WOW, oik and loik, etcetera
Version: 1.11
Author: bobbingwide
...
// If we include oik-add-shortcodes.php we effectively include ALL the other shortcodes
// is this a good or a bad thing?
...
//add_action( "init", "oik_bob_bing_wide_init" );
...
bw_add_shortcode( 'loik', 'bw_loik', oik_path("shortcodes/oik-bob-bing-wide.php"), true ); // Link to the plugin  
...
bw_add_shortcode( 'lwp', 'bw_lwp', oik_path("shortcodes/oik-bob-bing-wide.php"), true ); // Link to WordPress.org 
bw_add_shortcode( 'lbp', 'bw_lbp', oik_path("shortcodes/oik-bob-bing-wide.php"), true ); // Link to BuddyPress.org 
bw_add_shortcode( 'wpms', 'bw_wpms', oik_path("shortcodes/oik-bob-bing-wide.php"), true );   // WordPress Multisite
bw_add_shortcode( 'lwpms', 'bw_lwpms', oik_path("shortcodes/oik-bob-bing-wide.php"), true ); // Link to WordPress multisite - .org
bw_add_shortcode( 'drupal', 'bw_drupal', oik_path("shortcodes/oik-bob-bing-wide.php"), true );   // Drupa;
bw_add_shortcode( 'ldrupal', 'bw_ldrupal', oik_path("shortcodes/oik-bob-bing-wide.php"), true ); // Link to Drupal.org
bw_add_shortcode( 'artisteer', 'bw_art', oik_path("shortcodes/oik-bob-bing-wide.php"), true ); // Artisteer
bw_add_shortcode( 'lartisteer', 'bw_lart', oik_path("shortcodes/oik-bob-bing-wide.php"), true ); // Link to artisteer.com 

bw_add_shortcode( 'lbw', 'bw_lbw', oik_path("shortcodes/oik-bob-bing-wide.php"), true); // Link to Bobbing Wide or other websites
