 ...
 * Store art-version as 'na' when it's not applicable ( not Artisteer)  - the value is returned as '' at runtime
 * so that the correct code for [bw_block] expansion is used.
 * Note: currently the correct code is the same as for Artiseer 3.0
 * 
*/ 
